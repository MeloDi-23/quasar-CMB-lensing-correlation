...
if __name__ == '__main__':
    ...
    if auto_range or cross_range:
        ...
        cov = np.vstack((
            np.hstack((cov[l_c:r_c, l_c:r_c]*cross_scaler, cov[l_c:r_c, cross_size+l_a:cross_size+r_a]*np.sqrt(cross_scaler))),
            np.hstack((cov[cross_size+l_a:cross_size+r_a, l_c:r_c]*np.sqrt(cross_scaler), cov[cross_size+l_a:cross_size+r_a, cross_size+l_a:cross_size+r_a]))
        ))
